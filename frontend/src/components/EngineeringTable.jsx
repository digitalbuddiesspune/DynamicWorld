  ...
  return (
    <div>
      <div className="bg-white rounded-2xl shadow-md overflow-hidden my-6 p-2 lg:p-0">
        {/* Subheading */}
        <h1 className="text-xl lg:text-2xl font-semibold text-white px-6 py-4 border-b text-center border-gray-200 bg-[#088080]">
          {subHeading}
        </h1>
        ...
        <div className="overflow-x-auto bg-gray-50">
          <table className="w-full text-left border-collapse">
            <thead className="bg-[#088080] text-white">
              <tr>
