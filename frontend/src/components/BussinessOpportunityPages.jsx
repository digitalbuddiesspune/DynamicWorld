...
const ActionButton = ({
  ...
  const variants = {
    primary:
      "bg-white/10 text-white shadow shadow-[#B3B3B3]/60 hover:-translate-y-0.5 hover:shadow-md focus-visible:ring-[#2B2B2B]",
    secondary:
      " text-[#2B2B2B] border border-[#D4D4D4] shadow-md hover:-translate-y-0.5 hover:bg-[#D4D4D4]/20 focus-visible:ring-[#2B2B2B]",
    ghost:
  ...
  return (
    <button className={`${base} ${styles} ${className}`}>{Content}</button>
  );
};
  ...
  const heroStats = [
    {
      icon: Handshake,
      value: "12,000+",
      label: "Successful admissions powered by our team",
    },
    {
      icon: Target,
      value: "₹10k – ₹50k",
      label: "Incentive range per admission",
    },
    {
      icon: Users,
      value: "100+",
      label: "UGC-approved Indian universities onboard",
    },
  ...
  const servicePillars = [
    {
      ...
      bullets: [
        "Engineering, Management, Law, Medical & more",
        "Boards + Vocational + Skill courses",
    ...
    },
    {
      ...
      bullets: [
        "Marketing toolkits & digital creatives",
        "Course & fee comparison sheets",
        "Dedicated counsellor dashboard",
      ],
    },
    {
      icon: ShieldCheck,
      ...
      bullets: [
        ...
        "Weekly masterclasses & refresher training",
        "Workspace access for client meetings",
      ],
    },
  ];
          ...
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] items-center">
            <div>
              ...
              <h1 className="mt-6 text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight">
                Become a Dynamic World Business Partner &amp; unlock premium
                admission earnings
              </h1>
              <p className="mt-4 text-base sm:text-lg text-indigo-100/90 leading-relaxed">
                Build a thriving education hub in your city with Dynamic World’s
                360° portfolio. Formally represent 100+ UGC universities, 4,000+
                international institutions, and offer immigration, visa, and
                placement services under one trusted brand.
              </p>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/10/5 backdrop-blur px-6 py-7 sm:px-8 sm:py-9 shadow-2xl">
              ...
              <p className="mt-2 text-sm text-indigo-100/90">
                Drive admissions across online, hybrid, and on-campus programmes
                with structured incentive slabs and marketing budgets designed
                to scale your centre quickly.
              </p>
              ...
              <div className="mt-6 flex items-start gap-3 rounded-2xl border border-white/15 bg-slate-900/50 px-4 py-3">
                ...
                <p className="text-sm text-indigo-100/90">
                  Partners enjoy co-branded positioning on dynamicworld.in, lead
                  routing support, and access to exclusive scholarship campaigns
          ...
          <div className="rounded-3xl bg-white shadow-2xl ring-1 ring-slate-200 px-6 sm:px-10 py-12">
            ...
            <div className="mt-12 rounded-2xl border border-slate-200 bg-slate-50 p-6 sm:p-8">
              ...
              <p className="mt-2 text-sm text-slate-600">
                A curated catalogue that covers every learner journey — from
                school to higher education, professional upgrades, overseas
                transition, and skill acceleration.
              </p>
  ...
  const onboardingTimeline = [
    {
      ...
      description:
        "Sign-up, KYC, and agreement. Success manager assigned with immediate portal access.",
    },
    {
      phase: "Day 7",
      title: "Toolkit handover & launch plan",
      description:
        "Receive marketing assets, pricing decks, and the first wave of leads to activate local outreach.",
    },
    {
      phase: "Day 14",
      title: "Go live with campaigns",
      description:
        "Run co-branded digital campaigns, host first counselling clinic, and start closing admissions.",
    },
  ];

  return (
    <section className="bg-[#F8F3ED] py-16 sm:pt-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <span className="inline-flex items-center gap-2 rounded-full bg-[#EDEEEB] px-3 py-1 text-xs font-semibold uppercase tracking-wide text-blue-700">
            Partner Experience
          </span>
          ...
          <p className="mt-3 text-sm sm:text-base text-slate-600 max-w-3xl mx-auto">
            We combine two decades of education counselling expertise with
            high-conversion marketing, automation, and people support so that
            you can focus on advising students and growing your business.
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-3xl bg-gradient-to-br from-indigo-600 via-blue-600 to-indigo-700 px-6 sm:px-8 py-8 text-white shadow-2xl">
              <h3 className="text-xl font-semibold">
                Powerful partner success infrastructure
              </h3>
              <p className="mt-3 text-sm sm:text-base text-indigo-100/90 leading-relaxed">
                Work with a dedicated success manager, marketing strategist, and
                admissions operations executive. We align university campaigns,
                scholarship drives, and local events around your catchment area.
              </p>
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-white/20 bg-white/10 px-4 py-4">
                  ...
                  <p className="text-xs text-indigo-100/90">
                    Education counselling legacy since 2005
                  </p>
                </div>
                <div className="rounded-2xl border border-white/20 bg-white/10 px-4 py-4">
                  <p className="text-2xl font-bold">99%</p>
                  <p className="text-xs text-indigo-100/90">
                    Partner retention with predictable payouts
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-8">
            <div className="grid gap-6">
              {successPlaybook.map(({ icon: Icon, title, items }) => (
                <div
                  key={title}
                  className="rounded-3xl bg-white shadow-xl ring-1 ring-slate-200 px-5 py-6"
                >
      ...
      <div className=" p-4 lg:p-6">
        <div className=" bg-[#008080] px-6 sm:px-8 py-8 text-white rounded-3xl shadow-2xl">
          <h3 className="text-xl font-semibold">
            Ready to unlock your education franchise?
          </h3>
          <p className="mt-3 text-sm sm:text-base text-indigo-100/90">
            Let’s align goals, territories, and launch timelines. Our team will
            curate a personalised revenue projection for your city and help you
            launch a high-trust education centre immediately.
          </p>
...
export const BusinessPartnerBenefits = () => {
  ...
  return (
    <section className="bg-[#F8F3ED] py-12 sm:py-16">
...
export const BusinessPartnerCommission = () => {
  const commissionTiers = [
    ...
    },
    {
      ...
      details:
        "Medical • Engineering • Management • Law • MBBS in India & Abroad",
      payout: "₹25,000 – ₹50,000 on each admission",
    },
    {
    ...
    <section className="py-12 sm:py-16 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-2xl border border-slate-200 shadow-xl">
          <div className="bg-[#008080] text-white rounded-t-2xl px-6 py-5">
