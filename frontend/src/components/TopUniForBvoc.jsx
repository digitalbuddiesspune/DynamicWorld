...
const TopUniForBvoc = () => {
  ...
  return (
    <section className="w-full bg-[#EDEEEB] text-[#31393C] py-8">
      {/* Header */}
      <header className="bg-[#313639] text-white text-xl lg:text-3xl font-semibold px-6 lg:px-10 py-6 rounded-b-2xl shadow-sm">
                ...
                >
                  ...
                  {site ? (
                    <a
                      ...
                      className="bg-[#313639] text-white text-sm px-4 py-2 rounded-lg shadow-sm hover:bg-[#3188e3] transition"
                    >
                      Visit Website
                    </a>
                  ) : (
