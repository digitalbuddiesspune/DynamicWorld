...
const Immegration02 = () => {
  ...
  return (
    <section className="lg:m-5">
      <div className="relative mx-auto max-w-7xl lg:rounded-2xl bg-[#313639] text-white px-2 lg:px-5 py-8">
        {/* soft overlay glow */}
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {services.map(({ icon: Icon, title, desc }, i) => (
            ...
            >
              ...
              {/* hover accent */}
              <div className="mt-4 h-0.5 w-0 bg-[#313639] text-white transition-all duration-300 group-hover:w-16" />
            </article>
          ))}
        </div>
