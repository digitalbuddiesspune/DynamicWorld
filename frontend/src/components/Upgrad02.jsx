      ...
      <div className="mx-auto max-w-7xl px-2 md:px-6 lg:px-8 py-10 lg:py-10">
        ...
        <div className="rounded-2xl bg-white shadow-sm ring-1 ring-black/5 p-4 lg:p-8 space-y-10">
          ...
          <section className="space-y-4 ">
            ...
            {/* Note / Callout */}
            <div className="mt-4 rounded-xl border border-[#3E96F4]/30 bg-[#2B2B2B]/5 p-4 md:p-5">
          ...
          <section className="space-y-5">
            ...
            <div className="pt-2 flex flex-col sm:flex-row gap-3">
              <a
                ...
                className="inline-flex items-center justify-center rounded-xl border border-[#3E96F4] px-5 py-3 text-[#3E96F4] text-sm md:text-base font-medium hover:bg-[#2B2B2B]/5 transition"
              >
                Get Counselling
              </a>
            </div>
