...
const ConfusedAboutCollege02 = () => {
  ...
  return (
    <div className="w-full">
      {/* Main Section */}
      <div className="bg-[#F5F5F5] border-t border-gray-300 h-[50%] py-4 sm:py-6 lg:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          {/* Confused About College Card */}
          <div className="bg-[#008080] rounded-xl p-4 sm:p-6 mb-6 sm:mb-8 w-full shadow-2xl border border-gray-300">
            <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
              {/* Left Side - Text Content */}
              <div className="flex-1 space-y-3 sm:space-y-4 text-left w-full lg:w-auto">
                {/* Main Heading */}
                <h1 className="text-2xl text-white sm:text-3xl lg:text-4xl font-bold  leading-tight drop-shadow-lg">
                  Confused About College?
                </h1>

                {/* Subheading */}
                <p className="text-sm text-white sm:text-base  font-semibold leading-relaxed">
                ...
                <button className="bg-white hover:bg-gray-100 hover:-translate-y-1  px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-medium text-sm sm:text-base flex items-center gap-2 transition-all duration-300 w-full sm:w-auto justify-center sm:justify-start shadow-lg">
                  <svg
                ...
                <div className="flex items-center">
                  ...
                  <span className="px-3 sm:px-4  text-xs sm:text-sm text-white">
                    or
                  </span>
                  <div className="flex-1 h-px bg-white"></div>
                </div>
                ...
                <div className="text-white text-center sm:text-left">
                  ...
                  <a
                    ...
                    className=" underline text-sm sm:text-base font-medium transition-colors duration-200 cursor-pointer"
                  >
                    7887881060
                  </a>
                </div>
